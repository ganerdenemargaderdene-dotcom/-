...
class ActionExplainGradeCode(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]):
        ...
        explanations: Dict[str, str] = {
            ...
            "E": "Хүндэтгэн үзэх шалтгаанаар улирлын шалгалтанд ороогүй тохиолдолд хэрэглэнэ (зурагт дурдсан).",
            "NC": "Багц цаг тооцохгүй бөгөөд уг хичээлийг оноотой судалсан гэсэн тэмдэглэгээ.",
            "CR": "Өөр сургуулийн багц цагийг шилжүүлэн тооцох үед хэрэглэнэ (зурагт дурдсан).",
            "R": "Тухайн хичээлийг амжилттай судалсан ч тодорхой шаардлагаар дахин судлах хүсэлт гаргасан тохиолдолд тэмдэглэнэ.",
            "W": "Хичээлийг цаашид судлах боломжгүй эсвэл хангалтгүй судалсан үед (зургийн тайлбар).",
            "NR": "Багш хугацаанд нь үнэлгээ тавьж системд оруулаагүй үед системээс автоматаар тавигдана (зурагт дурдсан).",
